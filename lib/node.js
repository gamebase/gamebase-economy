...
Node.prototype.useCommodity = function(commodity, amount) {
    ...
    this.emit('consumed', {commodity: commodity, quantity: amount, total: this.commodities[commodity]});
    return true;
} 
...
Node.prototype.onProduce = function(options) {
    ...
    this.emit('produced', {commodity: options.commodity, quantity: options.quantity, total: commodity});
}
...
Node.prototype.onImport = function(contract) {
    ...
    this.emit('imported', {commodity: contract.commodity, quantity: contract.quantity, total: commodity});
}
